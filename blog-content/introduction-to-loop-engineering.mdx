...
Boris Cherny created Claude Code as a side project in September 2024. It now accounts for close to 4% of all public commits on GitHub. At WorkOS Acquired Unplugged on June 2, four days before Steinberger's post, he gave the cleanest definition:
...
**Dollar budget.** Claude Code supports a cost limit per session. Set a per-task budget in the loop and cancel before it is exceeded. Not a failure state, just a guard.
