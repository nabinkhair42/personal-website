...
The markdown version is 15x smaller, 100% parseable, and contains every fact from the original page. When an AI agent ingests this, it can answer &ldquo;how much does the Pro plan cost?&rdquo; or &ldquo;do they offer SLAs?&rdquo; with perfect accuracy.
...
```mermaid
flowchart LR
    A["🤖 AI Agent"] -->|"Accept: text/markdown"| S["example.com/pricing"]
    B["🌐 Browser"] -->|"Accept: text/html"| S
    S -->|"200 OK · text/markdown · 2kb"| A
    S -->|"200 OK · text/html · 500kb"| B
```
