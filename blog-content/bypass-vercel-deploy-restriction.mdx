...
- **`vercel deploy --prebuilt`** uploads only the build artifacts — Vercel does not run your build or receive your git source tree, though the build still happens in CI where your code is checked out
