...
<Note type="success" title="What Makes Snip Special">
  Snip is designed with **privacy-first architecture** - all processing happens locally on your machine, giving you complete control over your AI interactions.
</Note>
...
<Stepper>
  ...
  <StepperItem title="Seamless Local Integration">
    - Works smoothly with LM Studio
    - Supports various local language models
...
<Note type="warning" title="System Requirements">
  While Snip is optimized for performance, you'll need appropriate hardware to run your chosen language model locally.
</Note>
...
<Note type="success" title="Contributing">
  Feel free to open issues, submit pull requests, or share your ideas on [GitHub](https://github.com/nabinkhair42/snip). Let's make Snip even better together!
</Note>
