...
export default function Note({
  ...
  const noteClassNames = clsx({
    "bg-zinc-50 dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800": type === "note",
    "bg-red-50 dark:bg-red-950/30 border-red-200 dark:border-red-800/50": type === "danger",
    "bg-orange-50 dark:bg-orange-950/30 border-orange-200 dark:border-orange-800/50": type === "warning",
    "bg-green-50 dark:bg-green-950/30 border-green-200 dark:border-green-800/50": type === "success",
  });
    ...
    <div className={cn("relative my-6", noteClassNames)}>
      ...
      <div className="relative border p-4">
        ...
        <div className="flex items-center gap-3 mb-3">
          <div className={cn("p-1.5 bg-white dark:bg-zinc-950 border border-current/20", iconColors)}>
            <Icon className="h-4 w-4" />
          </div>
          <div className="flex items-center gap-2 flex-1">
            <h4 className={cn("font-mono text-sm uppercase tracking-wide font-medium", titleColors)}>
              {title}
            </h4>
