        ...
        <div className="space-y-3 p-2">
          <header className="space-y-2">
            ...
            <p className="text-base leading-relaxed text-justify text-muted-foreground">
              Pick the channel that fits best every link here stays in sync with
              my latest work.
            </p>
          </header>
          ...
          <div className="flex flex-col space-y-2">
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Email lands straight in my inbox and my resume is updated with
