  ...
  return (
    <ShellWrapper>
      <div className="flex flex-col gap-3 py-2 md:flex-row">
        <div className="relative size-28 shrink-0 self-start md:mt-1 md:size-32">
          <Image
            src={avatar}
            ...
            priority
            className="rounded-md border object-cover shadow-md outline-1 outline-foreground/10"
          />
        </div>
