        ...
        <section className="relative px-6 py-24 border-b  border-zinc-200 dark:border-zinc-800 overflow-hidden bg-zinc-50 dark:bg-zinc-900">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center animate-in fade-in duration-1000 slide-in-from-bottom-4">
                ...
                <p className="text-lg md:text-xl text-zinc-600 dark:text-zinc-400 font-light leading-relaxed max-w-3xl mx-auto mb-12 animate-in fade-in duration-700 delay-500">
                    A curated collection of digital experiences, ranging from web applications to browser extensions. 
                    Each project represents a unique challenge solved through thoughtful design and engineering.
                </p>
                ...
                <div className="flex items-center justify-center gap-12 text-center animate-in fade-in duration-700 delay-700">
                    ...
                    <div className="space-y-1">
                        <div className="text-2xl font-light text-zinc-900 dark:text-zinc-100 font-mono">3+</div>
                        <div className="text-sm tracking-wide uppercase text-zinc-500 dark:text-zinc-400 font-mono">Years</div>
                    </div>
                    <div className="w-px h-8 bg-zinc-300 dark:bg-zinc-700"></div>
                    <div className="space-y-1">
                        <div className="text-2xl font-light text-zinc-900 dark:text-zinc-100 font-mono">∞</div>
                        <div className="text-sm tracking-wide uppercase text-zinc-500 dark:text-zinc-400 font-mono">Learning</div>
                    </div>
                </div>
            </div>
