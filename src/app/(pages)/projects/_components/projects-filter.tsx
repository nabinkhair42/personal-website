...
import { BG, SECTION, TYPO } from '@/constants/ui';
...
export const ProjectsFilter = ({
  ...
  return (
    <section
      className={`${SECTION.base} border-b border-zinc-200 dark:border-zinc-800 ${BG.gradient}`}
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-4 mb-8">
          ...
          <span className={TYPO.sectionKicker}>Filter Projects</span>
          <div className="w-2 h-2 bg-zinc-400 dark:bg-zinc-600 rotate-45"></div>
          <div className="w-12 h-px bg-zinc-300 dark:bg-zinc-700"></div>
        </div>
