              ...
              >
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="group relative w-full overflow-hidden rounded-2xl bg-gradient-to-br from-card to-card/80 p-6 shadow-lg ring-1 ring-border/50 transition-all hover:shadow-xl hover:ring-primary/50 md:max-w-md"
                  >
