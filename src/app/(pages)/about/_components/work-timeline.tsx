...
import { FinfoxLogo, UncleSamsTechLogo, TrulyCareLogo } from './Logos';
...
export const WorkTimeline = () => {
  return (
    <section
      className={`${SECTION.base} border-t border-zinc-200 dark:border-zinc-800 ${BG.surface}`}
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-4 mb-6">
            ...
            <span className={TYPO.sectionKicker}>Professional Journey</span>
            <div className="w-8 h-px bg-zinc-300 dark:bg-zinc-700"></div>
          </div>
