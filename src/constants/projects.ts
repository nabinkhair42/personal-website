...
export interface Project {
  ...
  sourceUrl?: string;
  features: string[];
  category: "Web App" | "Chrome Extension" | "Blog Platform" | "API Service" | "Educational" | "E-commerce";
  year: string;
...
export const projects: Project[] = [
  ...
  },
  {
    id: "juju",
    title: "JuJu",
    description: "Juju is where creativity comes alive. Share your moments, express yourself, and be part of a vibrant community that celebrates originality.",
  ...
  },
  {
    id: "vthemes",
    title: "V Themes",
    description: "A professionally crafted color theme based on advanced color theory principles, designed to reduce eye strain and enhance code readability during long coding sessions",
  ...
  },
  {
    id: "pro-mcp",
    title: "Pro MCP",
    description: "Discover more than 4k+ protocol-compliant MCP servers to enhance your AI applications with external data and tools.",
  ...
  },
  {
    id: "receipt-vault",
    title: "Receipt Vault",
    description: "Effortlessly store and categorize your receipts. ReceiptVault is your small business partner in smart expense management.",
  ...
  },
  {
    id: "birat-express",
    title: "Birat Express",
    description: "A regional news platform for Koshi Province, offering real-time news updates and a user-friendly interface.",
  ...
  },
  {
    ...
    demoUrl: "https://chromewebstore.google.com/detail/google-bulk-photos-delete/ejimjaolhecpjkpbfkbccbigfdmdcpom",
    features: [
  ...
  },
  {
    ...
    description: "A US based tech startup, developed the website using Next.js and Tailwind CSS, and deployed it on Cloudflare Pages.",
  ...
  },
  {
    ...
    description: "A web application that helps users calculate Bitcoin values based on the latest market rates. It provides an intuitive interface for tracking and converting Bitcoin amounts.",
